...
const ContactUs = (): React.ReactElement => {
  return (
    <section className='bg-white dark:bg-gray-900'>
      <div className='py-1 lg:py-2 px-4 mx-auto max-w-screen-md'>
        <h2 className='mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white'>
          Contact Us
        </h2>
        <p className='mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl'>
          Interested in working together with me?
          Do you want me to colaboration with you?
          Leave an email or contact me directly.
        </p>
        <form
          action='#'
          className='space-y-8'>
          ...
          <button
            type='submit'
            className='py-3 px-5 text-sm font-medium text-center text-black rounded-lg bg-red-700 sm:w-fit hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800'>
            Send message
          </button>
        </form>
      </div>
