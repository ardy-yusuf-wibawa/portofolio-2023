...
export const myDev: Record<string, Dev> = {
  Dev_1: {
    ...
    description: 'Website ini dibuat pada saat pertama kali mengikuti bootcamp HTML harsenin.com '
  },
  Dev_2: {
    name: 'Predator',
    img: './img/porto-2.png',
    version: '0.1.0',
    ingredients: ['HTML ', 'Tailwind CSS ', 'Javascript'],
    description:
  ...
  Dev_3: {
    ...
    img: './img/porto-3.png',
    version: '0.1.0',
    ingredients: ['ReactJS', 'Tailwind CSS ', 'ExpressJS', 'typescript', 'MySQL'],
